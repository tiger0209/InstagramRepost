...
NSString *ProfileMediaCellIdentifier3 = @"ProfileMediaCellIdentifier3";
NSString *PrivateCellIdentifier3      = @"PrivateCellIdentifier3";
NSString *HeaderIdentifier3           = @"HeaderIdentifier3";
NSString *FooterIdentifier3          = @"FooterIdentifier3";

@interface LikesCollectionViewController ()
...
@implementation LikesCollectionViewController
{
    BOOL isRunning;
}
...
//        return;
    ...
    [[InstagramClient sharedClient] getUserLikesForIdentifier:self.user.identifier
...
{
    if(self.private == NO) {
        MediaCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:ProfileMediaCellIdentifier3 forIndexPath:indexPath];
        ...
        PrivateCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:PrivateCellIdentifier3 forIndexPath:indexPath];
