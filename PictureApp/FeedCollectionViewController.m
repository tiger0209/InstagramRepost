...
NSString *ProfileMediaCellIdentifier1 = @"ProfileMediaCellIdentifier1";
NSString *PrivateCellIdentifier1      = @"PrivateCellIdentifier1";
NSString *HeaderIdentifier1           = @"HeaderIdentifier1";
NSString *FooterIdentifier1           = @"FooterIdentifier1";
...
//        return;
    ...
    [[InstagramClient sharedClient] getUserFeedForIdentifier:self.user.identifier
...
{
    if(self.private == NO) {
        MediaCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:ProfileMediaCellIdentifier1 forIndexPath:indexPath];
...
//        // Media setup
        ...
        PrivateCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:PrivateCellIdentifier1 forIndexPath:indexPath];
